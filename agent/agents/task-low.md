---
name: task:low
description: "General-purpose low-cost tier on an Opus-class model: blended cost about USD 0.01 per 1M tokens across input, output, and cached tokens, cheaper than any DeepSeek version. Handles any bounded slice, and is the validator for free-tier work: independently checks its claims against artifacts and runtime evidence, reproduces decisive checks, and adjudicates disagreements."
